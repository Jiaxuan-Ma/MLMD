...
if st.session_state["authentication_status"]:
    ...
    if file is not None:
        ...
        st.write(df_nrow)
        colored_header(label="DATA INFORMATION",description=" ",color_name="violet-30")
    ...
    #                         plot.set_tick_fontsize(3),plot.set_legend_fontsize(4),plot.set_color('line color',19,5),plot.set_color('bin color',7,6)]
    #     with col2:
    ...
    #                         plot.set_tick_fontsize(9),plot.set_legend_fontsize(10), plot.set_color('line color',19,11), plot.set_color('bin color',7,12)]
    #     with col2:
    ...
    #                         plot.set_tick_fontsize(15),plot.set_legend_fontsize(16),plot.set_color('bin color',7, 17)]
    #     with col2:
    ...
    #                         plot.set_tick_fontsize(20),plot.set_legend_fontsize(21), plot.set_color('bin color', 7, 22)]
    #     with col2:
    ...
    #                         plot.set_tick_fontsize(25),plot.set_legend_fontsize(26),plot.set_color('scatter color',7, 27),plot.set_color('line color',19,28)]
    #     with col2:
    ...
    #                             plot.set_tick_fontsize(31),plot.set_legend_fontsize(32),plot.set_color('scatter color',7, 33),plot.set_color('line color',19,34)]
    #         with col2:
