...
st.write('## TUNE DECISION TREE PARAMETERs')
st.write('---')
...
if st.session_state["authentication_status"]:
    ...
    if file is not None:
        ...
        colored_header(label="TUNE DECISION TREE PARAMETERs",description=" ",color_name="violet-70")
        ...
        if inputs['model'] == 'DecisionTreeRegressor':
            ...
            if inputs['tune_parameter'] == 'max depth':
        ...
        with tab2:
            ...
            scoring = st.selectbox('scoring',('neg_mean_absolute_error','neg_mean_squared_error','r2'), key=43211)
            ...
            reg.model = tree.DecisionTreeRegressor(random_state=1024)
